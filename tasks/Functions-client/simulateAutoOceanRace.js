...
task("functions-simulate-aor", "Simulates an end-to-end fulfillment locally for the AutomatedOceanRace contract")
  .addOptionalParam(
    "gaslimit",
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const clientFactory = await ethers.getContractFactory("AutomatedOceanRace")
      ...
      registry.on(
        ...
        async (
          ...
          if (requestId == eventRequestId) {
            ...
            const _position = await client.position("0x9745fbfeCE314C2C9D4817e636Bc174236371Eb8")
            console.log(`Position: ${_position}`)
            //const requestAddress = await client.requestAddress();
            //console.log(`requestAddress: ${requestAddress}`)
            //const newPlayer = await client.players(2);
