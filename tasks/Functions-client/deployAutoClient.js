...
task("functions-deploy-auto-client", "Deploys the AutomatedOceanRace contract")
  ...
  .setAction(async (taskArgs) => {
    ...
    console.log(`Deploying AutomatedOceanRace contract to ${network.name}`)

    console.log("\n__Compiling Contracts__")
    await run("compile")

    const autoClientContractFactory = await ethers.getContractFactory("AutomatedOceanRace")
